...
const SignInForm = () => {
  return (
    <div className="rounded-tr-4xl px-10  pb-4">
      <h1 className="text-2xl font-semibold mb-6">Sign in to</h1>
      <Logo />
      ...
      <span className="mt-4 block transition-all duration-150  hover:text-indigo-800  dark:text-gray-300 dark:hover:text-white">
        ...
        Doloribus quia et nobis, perferendis facilis laborum blanditiis ex
        explicabo voluptatem harum, quibusdam nisi culpa, alias deleniti! Quod,
        in odit?
      </span>
    </div>
  );
