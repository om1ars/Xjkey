      ...
      <div id="featured-jobs__items" className="!-m-4">
        ...
        >
          {featuredJobsItems.map((item, i) => (
            <SwiperSlide key={i}>
              <Link href="/#">
                <a className="group block overflow-hidden  border border-slate-200 bg-white rounded-sm transition-all duration-150 hover:-translate-y-1 hover:shadow-lg dark:border-slate-800 dark:bg-slate-700">
