    ...
    <>
      <header className="sticky inset-x-0 top-0 z-20 flex items-center justify-between bg-white py-2 px-2 shadow-lg dark:bg-slate-900/75 sm:py-3 sm:px-8">
        ...
        <div className="flex shrink-0 grow-0 basis-1/3 justify-center md:justify-start">
          ...
          <li className="flex items-center  hover:cursor-pointer pl-6 ">
            <div className="w">
              <div className="dropdown inline-block relative ">
                <button className="mb-3 transition-all text-text   rounded items-center">
                  <span className="mr-1 flex items-center font-bold">
                    Products
                  </span>
                </button>
                <ul className="dropdown-menu rounded-xl   justify-center w-72 items-center  absolute hidden      text-lg ">
                  <div className="bg-whiteBg shadow-xl  justify-center items-center">
                    <li className=" flex flex-col  text-textBold hover:bg-textBold hover:text-whiteBg  pt-5 pl-5 pr-16 pb-7">
                      <span className="">AlgoExpert</span>
                      <span className="text-sm text-textSmColor">
                        Ace the coding interview
                      </span>
                    </li>
                    <li className="pb-7   hover:bg-templatesBg hover:text-whiteBg  pt-5 pl-5 pr-16 ">
                      <span className="">200 templates</span>
                      <span className="text-sm text-textSmColor">
                        Ace the coding interview
                      </span>{" "}
                    </li>
                    <li className="  pb-7 hover:bg-frontendBg hover:text-whiteBg  pt-5 pl-5 pr-16 ">
                    ...
                    <li className=" pb-7  hover:bg-coursesBg hover:text-whiteBg  pt-5 pl-5 pr-16 ">
                      <span className="">ProgammingExpert</span>
                      <span className="text-sm text-textSmColor">
                        Ace the coding interview
                      </span>
                    </li>
