                    ...
                    <Menu.Items className="absolute left-12 w-72 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <ul className="dropdown-menu  w-72 items-center  justify-center rounded-xl      text-lg ">
                        <div className="bg-whiteBg items-center  justify-center shadow-xl">
                          ...
                          <li className="  hover:bg-green-600 hover:text-white  pb-7  pt-5 pl-5 pr-16 ">
                          ...
                          <li className=" hover:bg-coursesBg hover:bg-sky-500 hover:  hover:text-whiteBg pb-7  pt-5 pl-5 pr-16 ">
