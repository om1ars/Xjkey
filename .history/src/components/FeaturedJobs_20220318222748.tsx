      ...
      <div id="featured-jobs__items" className="!-m-4">
        ...
        >
          {featuredJobsItems.map((item, i) => (
            <SwiperSlide key={i}>
              <a >
                <a href={`#${item.href}`} className="group block overflow-hidden bg-white rounded transition-all duration-150 hover:-translate-y-1 hover:shadow-lg dark:border-slate-800 dark:bg-slate-700">
