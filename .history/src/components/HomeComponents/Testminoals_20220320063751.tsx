            ...
            <SwiperSlide key={i}>
              <a>
                <a
                  href={`#${item.href}`}
                  id={item.href}
                  className="relative dark:border-slate-800 dark:bg-slate-700 group block overflow-hidden rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
                >
                  <div className="relative  overflow-hidden flex items-center justify-center absolute ">
                    <Image
                      src={item.image}
