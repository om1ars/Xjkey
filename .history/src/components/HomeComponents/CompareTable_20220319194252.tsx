                ...
                <tbody className="bg-white">
                  ...
                  <tr className="border-b border-gray ">
                    ...
                    <td className="whitespace-nowrap border-t py-4 px-6 text-sm text-gray-500 dark:text-gray-400">
                      <span className="rounded text-successText bg-successColor pl-24 pr-24 pt-2 pb-2">
                        Mavjud
                      </span>
                    </td>
                    <td className="whitespace-nowrap border-t py-4 px-6 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <td className="whitespace-nowrap py-4 px-6 text-sm text-gray-500 dark:text-gray-400">
                      <span className="rounded bg-green-100 pl-24 pr-24 pt-2 pb-2">
                        Mavjud
                      </span>
                    </td>
                  </tr>
                  ...
                  <tr className="border-b border-gray ">
                    ...
                    <td className="whitespace-nowrap py-4 px-6 text-sm text-gray-500 dark:text-gray-400">
                      <span className="rounded bg-red-100 pl-24 pr-24 pt-2 pb-2">
                        Mavjud
                      </span>{" "}
                    </td>
                    <td className="whitespace-nowrap py-4 px-6 text-sm text-gray-500 dark:text-gray-400">
