  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          className="w-full outline-none appearance-none border-transparent p-2 text-xl leading-6 text-textBold placeholder-textBold focus:border-transparent focus:ring-0"
          type="text"
