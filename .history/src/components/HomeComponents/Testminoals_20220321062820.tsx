  ...
  return (
    <section id="why-us" className="flex flex-col">
      ...
      <div id="featured-jobs__items" className="!-m-4">
        ...
        <button className="mt-10 rounded  flex items-center justify-center border-2 bg-buttonBg pl-4 pr-4 pt-2 pb-2 text-white transition-all hover:bg-buttonHover">
