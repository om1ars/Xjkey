            ...
            <SwiperSlide key={i}>
              <a>
                <a
                  href={`#${item.href}`}
                  id={item.href}
                  className="group block overflow-hidden rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg dark:border-slate-800 dark:bg-slate-700"
                >
