...
export default function AboutUs() {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center">
        <h1 className="mt-2 mb-2 text-4xl font-medium  text-mainBg hover:text-white hover:bg-mainBg">
          What is EzCode?
        </h1>
        <div className="mt-3 flex items-center justify-center border-2 border-mainBg pl-4 pr-4 pt-2 pb-2">
