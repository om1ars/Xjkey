              ...
              <table className="min-w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b odd:bg-white even:bg-gray-50 dark:border-gray-600 odd:dark:bg-gray-800 even:dark:bg-gray-700">
                    ...
                    <td className="whitespace-nowrap py-4 border-t px-6 text-sm text-gray-500 dark:text-gray-400">
                      Sliver
                    </td>
                    <td className="whitespace-nowrap py-4 border-t px-6 text-sm text-gray-500 dark:text-gray-400">
                      Laptop
                    </td>
                    <td className="whitespace-nowrap py-4 px-6 border-t text-sm text-gray-500 dark:text-gray-400">
                      $2999
                    </td>
                    <td className="whitespace-nowrap py-4 px-6 text border-t-right text-sm font-medium">
                      <a
                        href="#"
