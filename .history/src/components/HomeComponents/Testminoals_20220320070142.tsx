  ...
  return (
    <section id="why-us">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-2xl font-bold">And Over 100,000 Satisfied Engineers.
          ...
          {whyusItems.map((item, i) => (
            <SwiperSlide key={i}>
              <>
                <div
                  id={item.href}
                  className="shadow-lg border-t-4 border-buttonBg dark:border-slate-800 dark:bg-slate-700  group relative block  rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
                >
                  <div className="dark:border-slate-600 relative  flex flex-col border-t p-4 text-center">
                    ...
                    <span className="mini_overflow h-60 overflow-y-scroll">
