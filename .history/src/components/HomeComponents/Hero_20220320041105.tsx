  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="hidden h-11 shrink-0 bg-textColor hover:bg-buttonBg px-2 font-semibold text-white transition-colors duration-500 ease-in-out hover:bg-butto sm:block"
        >
          Discover Now
        </button>
      </div>
