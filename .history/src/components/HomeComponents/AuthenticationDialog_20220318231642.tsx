          ...
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 align-middle shadow-xl transition-all dark:bg-gray-800">
                <span className="mx-auto flex w-[140px] "></span>
                <div className="rounded-tr-4xl px-10  pb-4">
                  <h1 className="mb-6 text-2xl font-semibold">Sign in to</h1>
                  <Logo />

                  <span className="mt-4 block transition-all duration-150  hover:text-indigo-800  dark:text-gray-300 dark:hover:text-white">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Minima, sit! Doloribus quia et nobis, perferendis facilis
                    laborum blanditiis ex explicabo voluptatem harum, quibusdam
                    nisi culpa, alias deleniti! Quod, in odit?
                  </span>
                </div>
