          ...
          {whyusItems.map((item, i) => (
            <SwiperSlide key={i}>
              <>
                <div
                  id={item.href}
                  className="shadow-lg border-t-4 dark:border-slate-800 dark:bg-slate-700  group relative block  rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
                >
