              ...
              <table className="min-w-full">
                <thead className="bg-white  ">
                  <tr className="">
                    <th
                      scope="col"
                      className="text-gray dark:text-gray-400 py-3 px-6 text-left text-xs font-medium uppercase tracking-wider"
                    >
                      Name
                    </th>
                    <th
                ...
                <tbody className="bg-white">
                  ...
                  <tr className="border-gray-200 border-b ">
                    ...
                    <td className="text-gray-500 dark:text-gray-400 whitespace-nowrap border-t py-4 px-6 text-sm">
                      <span className="bg-red-100 rounded pl-24 pr-24 pt-2 pb-2">
                        Mavjud
                      </span>
                    </td>
