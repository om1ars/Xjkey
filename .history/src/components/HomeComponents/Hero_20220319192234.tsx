...
const SearchForm = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="pointer-events-none block px-2 text-textBold group-focus-within:text-indigo-800">
          <svg
            className="h-6 w-6"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <input
          className="w-full appearance-none border-transparent p-2 text-xl leading-6 text-textBold placeholder-textBold focus:border-transparent focus:ring-0"
          type="text"
