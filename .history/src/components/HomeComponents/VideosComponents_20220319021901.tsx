...
export default function VideosComponents() {
  return (
    <div className="flex justify-between -justify sm:flex-col  md:flex-col lg:flex-row">
      <div className="w-6/12 pl-5 pr-5">
        ...
        <div className="mt-12 flex sm:flex-col md:flex-col lg:flex-row">
          <div className="mr-10 ">
            <div className="mb-3 text-2xl  text-black flex">
              <h3 className="">Conceptual Overview</h3>
