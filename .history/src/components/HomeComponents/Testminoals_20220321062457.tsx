...
export const Testimonials = () => {
  return (
    <section id="why-us" className="flex">
      ...
      <div id="featured-jobs__items" className="!-m-4">
        ...
        <div className="mt-10 flex items-center justify-center border-2  bg-buttonBg pl-4 pr-4 pt-2 pb-2 transition-all hover:bg-buttonHover text-white">
