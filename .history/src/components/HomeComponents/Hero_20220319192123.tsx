  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          className="hidden h-11 shrink-0 bg-textColor hover:bg-text px-2 font-semibold text-white transition-colors duration-500 ease-in-out hover:bg-indigo-700 sm:block"
        >
          Discover Now
        </button>
      </div>
