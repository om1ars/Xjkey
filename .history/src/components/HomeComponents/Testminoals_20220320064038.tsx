            ...
            <SwiperSlide key={i}>
              <a>
                <a
                  href={`#${item.href}`}
                  id={item.href}
                  className="relative dark:border-slate-800 dark:bg-slate-700 group block  rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
                >
                  <div className="  overflow-hidden  absolute left-24  bottom-12 z-10">
                    <Image
                      src={item.image}
                      ...
                      width={40}
                      height={40}
                      className="  flex items-center justify- rounded-full transition-all duration-200 group-hover:scale-[102%]"
                    />
                  </div>

                  <div className="dark:border-slate-600 flex flex-col border-t p-4">
                    <h5 className="block truncate text-xl mt-6 font-semibold capitalize">
                      {item.jobTitle}
                    </h5>
