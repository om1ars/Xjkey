...
import ModalVideo:any from "react-modal-video";
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="mt-3 flex items-center justify-center border-2 hover:text-white hover:bg-mainBg transition-all border-mainBg pl-4 pr-4 pt-2 pb-2">
