            ...
            <SwiperSlide key={i}>
              <a>
                <a
                  href={`#${item.href}`}
                  id={item.href}
                  className="relative dark:border-slate-800 p dark:bg-slate-700 group block  rounded bg-white transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
                >
