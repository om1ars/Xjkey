...
const Hero = ({ title, subtitle, line }: any) => {
  ...
  return (
    <>
      <div className="relative h-[440px] w-full bg-mainBg text-white sm:h-[45vh] md:h-[400px]">
        {/* <Image
        ...
        <div className="absolute inset-0 bg-neutral-900/70">
          <div className="mx-auto max-w-screen-lg">
            ...
            <div className="mx-4  mt-16 flex flex-col items-center text-center">
              <h1 className={`text-xl font-extrabold uppercase tracking-wide text-white sm:text-4xl md:text-3xl lg:text-4xl ${line && 'line-through	'}`}>
                {title}
              </h1>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <input
          className="w-full outline-none border-none appearance-none border-transparent p-2 text-xl leading-6 text-textBold placeholder-textBold focus:border-transparent focus:ring-0"
          type="text"
