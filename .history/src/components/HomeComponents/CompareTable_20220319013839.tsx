              ...
              <table className="min-w-full">
                <thead className="bg-gray-100  ">
                  <tr className="">
                    ...
                    <th
                      scope="col"
                      className="py-3 px-6   pt-16 pb-16 text-left text-xs font-medium uppercase tracking-wider text-gray-700 dark:text-gray-400"
                    >
                      Color
                    </th>
                    <th
                ...
                <tbody>
                  ...
                  {/* Product 2 */}
                  <tr className="border-b odd:bg-white even:bg-gray-50 dark:border-gray-600 odd:dark:bg-gray-800 even:dark:bg-gray-700">
                    <td className="whitespace-nowrap py-4 pt-6 pb-6 px-6 text-sm font-medium text-gray-900 dark:text-white">
