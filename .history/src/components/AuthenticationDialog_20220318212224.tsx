...
const SignInForm = () => {
  return (
    <div className="rounded-tr-4xl px-10 pt-4 pb-4">
      ...
      >
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima, sit! Doloribus quia et nobis, perferendis facilis laborum blanditiis ex explicabo voluptatem harum, quibusdam nisi culpa, alias deleniti! Quod, in odit?
      </a>
    </div>
  );
};
