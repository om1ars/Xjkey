                    ...
                    <Menu.Items className="divide-gray-100 ring-black  absolute top-12 left-1 w-80 origin-top-right divide-y rounded-md bg-white shadow-lg ring-1 ring-opacity-5 focus:outline-none">
                      <ul className="dropdown-menu    items-center  justify-center rounded-xl      text-lg ">
                        <div className="items-center justify-center bg-whiteBg  text-left shadow-xl">
                          <li className=" hover:bg-textColor flex flex-col  pt-5 pl-5 pr-16  pb-7  hover:text-whiteBg hover">
                            <span className="">AlgoExpert</span>
                            <span className="text-textSmColor text-sm">
                              Ace the coding interview
                            </span>
                          </li>
                          <li className=" front_main_drop hover:bg-fColor relative flex flex-col  pt-5 pl-5 pr-16  pb-7 text-mainBg  hover:text-white">
                          ...
                          <li className=" back_main_drop  hover:bg-beColor flex flex-col  pt-5 pl-5 pr-16  pb-7 text-mainBg  hover:text-white">
                          ...
                          <li className=" hover:bg-seColor flex flex-col  pt-5 pl-5 pr-16  pb-7 text-textBold hover:text-whiteBg hover:text-white">
                          ...
                          <li className=" hover:bg-orange-400 flex flex-col  pt-5 pl-5 pr-16  pb-7 text-mainBg hover:text-whiteBg hover:text-white">
