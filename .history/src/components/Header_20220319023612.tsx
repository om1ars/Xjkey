                ...
                <Menu as="div" className="relative ">
                  ...
                  >
                    <Menu.Items className="absolute left-12 w-72 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <ul className="dropdown-menu absolute   hidden w-72 items-center  justify-center rounded-xl      text-lg ">
                        <div className="bg-whiteBg items-center  justify-center shadow-xl">
                          <li className=" text-textBold hover:bg-textBold  hover:text-whiteBg flex flex-col  pt-5 pl-5 pr-16 pb-7">
                            <span className="">AlgoExpert</span>
                            <span className="text-textSmColor text-sm">
                              Ace the coding interview
                            </span>
                          </li>
                          <li className="hover:bg-templatesBg   hover:text-whiteBg pb-7  pt-5 pl-5 pr-16 ">
