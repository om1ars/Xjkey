                        ...
                        <div className="bg-whiteBg items-center justify-center  text-left shadow-xl">
                          ...
                          <li className=" back_main_drop text-textBold hover:text-whiteBg flex  flex-col pt-5 pl-5  pr-16 pb-7 hover:bg-red-700 hover:text-white">
                            ...
                            <div className="back_sub_drop absolute left-80 top-48 hidden w-64 items-center rounded-tr rounded-br bg-white pt-5  pb-5 pl-1     text-left  ">
                              <ul className="flex flex-wrap items-center">
                                <li className="ml-2 mr-2 rounded-2xl bg-green-100 pl-3 pr-3 pt-1 pb-1 text-yellow-500">
                                  Django
                                  <i className="devicon-python-plain colored"></i>
                                </li>
                                <li className="rounded-2xl bg-green-200 pl-3 pr-3 pt-1 pb-1 text-black">
                                  Spring
