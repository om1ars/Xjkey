...
export default function Footer() {
  return (
    <div>
      <div className="bg-mainBg mt-10 text-whiteBg flex flex-col items-center justify-center pl-48 pr-48 pt-8 pb-10">
        <div className="sm:flex sm:flex-wrap md:flex md:flex-wrap lg:flex ">
          <div className="ml-4 flex ">
            <span className="mr-2 ml-2">
              <Link href="/help">Contact us</Link>
            </span>
            <div className=" ml-2 w-0.5 bg-gray"></div>
          </div>
          <div className="ml-4 flex ">
            <span className="mr-2 ml-2">FAQ</span>
            <div className=" ml-2 w-0.5 bg-gray-500"></div>
          </div>
          <div className="ml-4 flex ">
