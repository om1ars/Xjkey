                      ...
                      <ul className="dropdown-menu   items-center  justify-center rounded-xl      text-lg ">
                        <div className="bg-whiteBg items-center justify-center  text-left shadow-xl">
                          ...
                          <li className=" text-textBold front_main_drop hover:text-whiteBg relative flex  flex-col pt-5 pl-5  pr-16 pb-7 hover:bg-yellow-500 hover:text-white">
                            ...
                            <div className="front_sub_drop absolute left-80 top-0 hidden w-80 items-center bg-white pt-3  pb-3 pl-5 pr-12  text-left  ">
                              <ul className="flex flex-wrap items-center">
                                ...
                                <li className="rounded-2xl mt-2 mb-2 ml-2 mr-2 text-green-500 bg-green-100 pl-3 pr-3 pt-1 pb-1">
                                  Vue.js
                                  <i className="devicon-vuejs-plain colored"></i>
                                </li>
                                <li className="rounded-2xl mt-2 mb-2 ml-2 mr-2 text-red-500 bg-red-100 pl-3 pr-3 pt-1 pb-1">
                                  Angular.js
                                  <i className="devicon-angularjs-plain colored"></i>
                                </li>
                                <li className="rounded-2xl mt-2 mb-2 ml-2 mr-2 items-center text-violet-500 bg-violet-100 pl-3 pr-3 pt-1 pb-1">
                                  Gatsby.js
