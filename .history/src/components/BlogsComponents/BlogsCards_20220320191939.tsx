        ...
        <div className="container mx-auto px-10 align-middle">
          <div className="flex flex-col gap-10 flex-wrap">
              ...
              <div className="flex flex-row items-center justify-start text-left">
                ...
                <p>
                  <span className="text-sm text-buttonBg">6min read</span> A while back, somewhere inside the AlgoExpert backend codebase, I had a function that looked something like this:
