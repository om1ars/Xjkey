...
export const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="dark:bg-slate-900/75  sticky inset-x-0 top-0 z-20 flex items-center justify-between  py-2 px-2 shadow-lg sm:py-3 sm:px-8">
        <MenuPopOver
        ...
        <div className="flex shrink-0 grow-0  items-center justify-center md:justify-start">
          <div className="hidden gap-2 md:ml-2 md:flex">
            <div className="mr-2 ml-2 text-textBold">
              <Link href="/#" passHref>
                Purchase
              </Link>
            </div>
