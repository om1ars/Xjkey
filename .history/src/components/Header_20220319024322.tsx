            ...
            <Link href="/#" passHref>
              <div className="text-right">
                <Menu as="div" className="relative ">
                  ...
                  >
                    <Menu.Items className="absolute right-1 w-72 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <ul className="dropdown-menu  w-72 items-center  justify-center rounded-xl      text-lg ">
                        <div className="bg-whiteBg items-center  justify-center shadow-xl">
                          ...
                          <li className="hover:text-whiteBg pb-7   pt-5 pl-5  pr-16 hover:bg-red-700 hover:text-white ">
                            <span className="">200 templates</span>
                            <span className="text-textSmColor text-sm">
                              Ace the coding interview
                            </span>{" "}
                          </li>
                          <li className="  pb-7 pt-5  pl-5  pr-16 hover:bg-green-600 hover:text-white ">
                          ...
                          <li className=" hover:bg-coursesBg hover:text-whiteBg pb-7  pt-5 pl-5  pr-16 hover:bg-sky-500 hover:text-white ">
