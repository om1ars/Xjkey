  ...
  return (
    <>
      <header className="sticky inset-x-0 top-0 z-20 flex items-center justify-between bg-white py-2 px-2 shadow-lg dark:bg-slate-900/75 sm:py-3 sm:px-8">
        ...
        />
        <div className="flex items-center shrink-0 grow-0 basis-1/3 justify-center md:justify-start">
          <Link href="/#">
            ...
            <Link href="/#" passHref>
              <div className="text-right">
                <Menu as="div" className="relative ">
                  ...
                  >
                    <Menu.Items className="absolute top-12 ml-2 mr-2 left-1 w-80 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <ul className="dropdown-menu  w-80 items-center  justify-center rounded-xl      text-lg ">
                        <div className="bg-whiteBg items-center justify-center  text-left shadow-xl">
                          ...
                          <li className=" text-textBold hover:text-whiteBg flex  flex-col pt-5 pl-5  pr-16 pb-7 hover:bg-yellow-500 hover:text-white">
        ...
        <div className="relative items-center flex basis-1/3 justify-end gap-2">
          <button
