  ...
  return (
    <div>
      ...
      <div className="">
        ...
        >
          <div className=" flex flex-col items-center justify-center pl-16 pr-16 rounded border bg-white pt-12 pb-12 shadow">
            <Image width={60} height={60} className="mb-4 mt-0 " src={product} />
