      ...
      <div className="flex flex-wrap gap-3">
        {whyusItems.map((item, i) => (
          <>
            <div
              id={item.href}
              className="w-1/4 dark:border-slate-800 dark:bg-slate-700 group relative   rounded border-t-4 border-buttonBg  bg-white shadow-lg transition-all duration-150 hover:-translate-y-1 hover:shadow-lg"
            >
