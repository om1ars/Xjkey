  ...
  return (
    <div>
      ...
      <div className="">
        ...
        >
          <div className=" flex flex-col items-center justify-center rounded border bg-white pl-16 pr-14 pt-9 pb-9 shadow">
            <Image
              width={60}
              height={60}
              className="mb-4 mt-0  "
              src={product}
            />
            <p className="text-lg mt-3 text-gray-700">Content goes here</p>
          </div>
        </div>
      </div>
    </div>
