...
export default function Help() {
  return (
    <div>
      ...
      <div className="bg-whiteBg mt-12 flex flex-col items-center justify-center pl-6 pr-6 ">
      ...
      <div className="flex flex-col items-center justify-center bg-whiteBg">
        ...
        <div className="flex items-center justify-center">
          ...
          >
            <div className=" flex flex-col items-center justify-center rounded  bg-white pl-16 pr-16 pt-9 pb-9 shadowshadow">
              <Image
                width={60}
                height={60}
                className="mb-4 mt-0"
