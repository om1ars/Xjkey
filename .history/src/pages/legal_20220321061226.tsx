...
export default function Legal() {
  return (
    <div>
        <Hero title="Boring Privacy Policy" line subtitle="Because we gotta have it" />
...
>
  <div className="mt-28 mb-28 space-y-20">
    <div className="rounded border-l-4 border-mainBg bg-white py-3 px-5 shadow  ">
      <div className="flex flex-row items-center justify-between">
        <div>
          <h6 className="text-xl font-semibold flex items-center justify-center gap-2  text-textBold">
            <AiOutlineInfoCircle className="text-2xl text-mainBg" />
            <span>Smoothly Rolling Out Pricing Changes Is Hard.</span>
          </h6>
    ...
    <div className="mt-4">
      ...
      <div className="mt-6">
        <span className="mt-3  text-lg font-semibold text-mainBg">
          Introduction
        </span>
        <p className="text mt-2 text-sm text-textColor">
          ...
          AlgoExpert website, you consent to the data practices described
          in this statement.
        </p>
      </div>
      <div className="mt-6">
