  ...
  return (
    <div className="">
      ...
      <div className="flex mt-12 flex-col items-center justify-center">
        <h1 className="mt-3 mb-3 text-2xl font-semibold text-mainBg">
        ...
        <Tippy
          content="Purchase 
         a product before submitting review"
        >
          <button className="mt-12 flex  items-center justify-center rounded  bg-buttonDisabled pl-4 pr-4 pt-2 pb-2 text-white transition-all ">
            Submit a review
          </button>
        </Tippy>
      </div>
      <div className="mt-10 w-full items-center justify-center gap-10 p-10 sm:flex-col md:flex-col lg:flex lg:flex-row lg:flex-wrap">
