...
export default function Help() {
  return (
    <div>
      ...
      <div className="">
        <div
          className="flex flex-wrap pl-28 pr-28 items-center justify-center  gap-4 bg-indigo-100 p-6"
          style={{ fontFamily: '"Muli", sans-serif' }}
        >
          <div className=" flex flex-col items-center justify-center rounded border bg-white  pt-9 pb-9 shadow">
            <Image
              width={60}
              height={60}
              className="mb-4 mt-0  "
