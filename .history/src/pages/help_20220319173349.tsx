...
export default function Help() {
  return (
    <div>
        <Hero title='You have questions' />
      <div
        className="flex min-h-screen w-screen items-center bg-indigo-100"
        ...
        <div className="container ml-auto mr-auto flex flex-wrap items-start">
          ...
          <div className="mb-5 w-full pl-5 pr-5 md:w-1/2 lg:w-1/4 lg:pl-2 lg:pr-2">
            <div className="m-h-64 transform rounded-lg bg-white p-2 transition duration-300 hover:translate-y-2 hover:shadow-xl">
              ...
              <div className="flex flex-col rounded-lg bg-purple-700 p-4">
                <div>
                ...
                <div className="flex items-center">
                  <div className="text-lg font-light text-white">$1099,00</div>
                  <button
                    // href="javascript:;"
                    className="ml-auto flex h-10 w-10 rounded-full bg-purple-900 text-white transition duration-300 hover:bg-white hover:text-purple-900 hover:shadow-xl focus:outline-none"
                  >
                    <svg
