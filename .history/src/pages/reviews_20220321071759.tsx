...
export default function Reviews() {
  return (
    <div className="">
      ...
      />
      <div className="mt-20 lg:flex  w-full sm:flex-col lg:flex-row md:flex-col lg:flex-wrap items-center justify-center gap-10">
        {whyusItems.map((item, i) => (
          <div key={i} className="lg:w-1/5 sm:w-full ">
            <div
              id={item.href}
