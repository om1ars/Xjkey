...
export default function Reviews() {
  return (
    <div className="">
      ...
      <h1 className="text-2xl font-semibold text-mainBg">Central Code Success Stories</h1>
      <p>
        We have over 100,000 customers on AlgoExpert. Every now and then, one of
        them reaches out to share their success story. Below is a collection of
